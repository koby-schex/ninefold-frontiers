...
This dependency-free executable compiles the actual Core C# files, runs 21 named
...
not canonical unit stats. Cooldowns, stun resolution, saves, geometry and rendering
are not implemented or tested by this PR.
