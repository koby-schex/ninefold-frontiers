...
This dependency-free executable compiles the actual Core C# files, runs 73 named
...
Health scenarios verify provisional damage formulas, preview/apply agreement, capped
healing, defeat/turn removal, target rejection and cost/state atomicity. Environmental
damage, passive effects, stun resolution, saves, geometry and rendering remain deferred.
